...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Our <a href='/docs'>docs</a> cater to every developer, all the way from beginners to those already building dapps via web3, and provide examples to build upon.
      </>
    ),
  },
  {
